...
export declare class ReportsController {
    ...
    getExpenses(req: any, res: Response, skip?: string, take?: string, search?: string, status?: string, categoryId?: string, dateFrom?: string, dateTo?: string, millId?: string, technicianId?: string, millName?: string, frameNo?: string, refNo?: string, exportType?: 'pdf' | 'csv' | 'excel'): Promise<Response<any, Record<string, any>>>;
