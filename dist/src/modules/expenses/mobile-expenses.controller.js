...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'dateFrom', required: false, type: String, description: 'Visit date lower bound — ISO date string `YYYY-MM-DD`' }),
    (0, swagger_1.ApiQuery)({ name: 'dateTo', required: false, type: String, description: 'Visit date upper bound — ISO date string `YYYY-MM-DD`' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Paginated list of expenses', schema: paginatedExpensesSchema }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', type: String, format: 'uuid', description: 'Expense UUID' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Expense detail', schema: expenseSchema }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Missing or invalid JWT bearer token', schema: errorSchema('Unauthorized') }),
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Not assigned to this expense', schema: errorSchema('You do not have permission to access this expense') }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Expense not found', schema: errorSchema('Expense with ID "..." not found') }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', type: String, format: 'uuid', description: 'Expense UUID to delete' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Expense soft-deleted — returns the updated record', schema: expenseSchema }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Missing or invalid JWT bearer token', schema: errorSchema('Unauthorized') }),
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Not assigned to this expense', schema: errorSchema('You do not have permission to access this expense') }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Expense not found', schema: errorSchema('Expense with ID "..." not found') }),
    __param(0, (0, common_1.Param)('id')),
