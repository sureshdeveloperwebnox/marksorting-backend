...
export declare class StoresController {
    ...
    findAll(skip?: string, take?: string, search?: string, millId?: string, millIdCamel?: string, serviceEngineerId?: string, serviceEngineerIdCamel?: string, customerId?: string, customerIdCamel?: string, materialId?: string, materialIdCamel?: string, warrantyStatus?: string, warrantyStatusCamel?: string, returnStatus?: string, returnStatusCamel?: string, inflowStatus?: string, inflowStatusCamel?: string, stockType?: string, stockTypeCamel?: string, dateFrom?: string, dateTo?: string, startDate?: string, endDate?: string, startDateSnake?: string, endDateSnake?: string): Promise<any>;
