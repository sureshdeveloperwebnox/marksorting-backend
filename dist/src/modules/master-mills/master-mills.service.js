...
let MasterMillsService = class MasterMillsService {
    ...
    async update(id, dto) {
        ...
        if (dto.invoice_no !== undefined)
            data.invoice_no = dto.invoice_no;
        if (dto.ref_no !== undefined)
            data.ref_no = dto.ref_no || null;
        if (dto.mill_id !== undefined)
            data.mill_id = dto.mill_id || null;
        if (dto.address !== undefined)
            data.address = dto.address || null;
        if (dto.place !== undefined)
            data.place = dto.place || null;
        ...
        if (dto.mc_model !== undefined)
            data.mc_model = dto.mc_model || null;
        if (dto.frame_no !== undefined)
            data.frame_no = dto.frame_no || null;
        if (dto.status !== undefined)
            data.status = dto.status;
        if (dto.warranty_years !== undefined)
            data.warranty_years = dto.warranty_years ?? 0;
        if (dto.warranty_months !== undefined)
            data.warranty_months = dto.warranty_months ?? 0;
        if (dto.amc_particular !== undefined)
            data.amc_particular = dto.amc_particular || null;
