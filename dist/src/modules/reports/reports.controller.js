...
let ReportsController = class ReportsController {
    ...
    async getExpenses(req, res, skip, take, search, status, categoryId, dateFrom, dateTo, createdDateFrom, createdDateTo, expenseDateFrom, expenseDateTo, millId, technicianId, millName, frameNo, refNo, exportType) {
        const params = {
            skip: skip ? parseInt(skip, 10) : 0,
            take: take ? parseInt(take, 10) : 10,
            search,
    ...
    async getMills(req, res, skip, take, search, status, customerId, refNo, place, city, dateFrom, dateTo, createdDateFrom, createdDateTo, exportType) {
        ...
        if (exportType) {
            ...
            return res.status(400).json({ message: 'Failed to export mills report' });
        }
        const data = await this.reportsService.getMills(params, req.user);
        return res.json(data);
    }
};
...
__decorate([
    ...
    __param(9, (0, common_1.Query)('createdDateFrom')),
    __param(10, (0, common_1.Query)('createdDateTo')),
    __param(11, (0, common_1.Query)('expenseDateFrom')),
    __param(12, (0, common_1.Query)('expenseDateTo')),
    __param(13, (0, common_1.Query)('millId')),
    __param(14, (0, common_1.Query)('technicianId')),
    __param(15, (0, common_1.Query)('millName')),
    __param(16, (0, common_1.Query)('frameNo')),
    __param(17, (0, common_1.Query)('refNo')),
    __param(18, (0, common_1.Query)('export')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, common_1.Get)('mills'),
    (0, swagger_1.ApiOperation)({ summary: 'Get mills reports log or export it' }),
    (0, log_activity_decorator_1.LogActivity)({
        action: activity_action_enum_1.ActivityAction.EXPORT,
        entityType: 'reports',
        description: (ctx) => {
            const exportType = ctx.query.export;
            return exportType
                ? `Exported mills reports as ${exportType.toUpperCase()}`
                : 'Viewed mills reports list';
        },
        ignoreNullEntity: true,
    }),
    (0, swagger_1.ApiQuery)({ name: 'skip', required: false, type: String }),
    ...
    (0, swagger_1.ApiQuery)({ name: 'customerId', required: false, type: String }),
    (0, swagger_1.ApiQuery)({ name: 'refNo', required: false, type: String }),
    (0, swagger_1.ApiQuery)({ name: 'place', required: false, type: String }),
    ...
    __param(5, (0, common_1.Query)('status')),
    __param(6, (0, common_1.Query)('customerId')),
    __param(7, (0, common_1.Query)('refNo')),
    __param(8, (0, common_1.Query)('place')),
