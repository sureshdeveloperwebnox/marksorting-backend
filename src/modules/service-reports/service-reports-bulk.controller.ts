...
export class ServiceReportsBulkController {
    ...
    @ApiOperation({ summary: 'Download the service report bulk upload Excel template' })
    ...
    @ApiOperation({ summary: 'Upload a service report Excel file and preview parsed rows' })
    ...
    @ApiOperation({ summary: 'Get the status of an ongoing or completed service report import' })
