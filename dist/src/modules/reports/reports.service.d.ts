...
export declare class ReportsService {
    ...
    getMills(params: ReportParams, user: UserSessionPayload): Promise<any>;
    exportMills(params: ReportParams, user: UserSessionPayload, formatType: 'pdf' | 'csv' | 'excel'): Promise<{
        buffer: Buffer;
        fileName: string;
        contentType: string;
    } | null>;
