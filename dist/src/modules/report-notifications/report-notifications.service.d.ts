...
export declare class ReportNotificationsService {
    ...
    sendServiceReport(reportId: string, millName: string, millEmail?: string | null, millWhatsappNumber?: string | null, authorizedPersonPhone?: string | null): Promise<ReportDeliveryResult>;
    sendInstallationReport(reportId: string, millName: string, millEmail?: string | null, millWhatsappNumber?: string | null, authorizedPersonPhone?: string | null): Promise<ReportDeliveryResult>;
