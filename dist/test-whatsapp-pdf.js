...
const pdf_service_1 = require("./src/modules/pdf/pdf.service");
async function testWhatsAppPdf() {
    const configService = new config_1.ConfigService();
    const pdfService = new pdf_service_1.PdfService(configService);
    const testHtml = `
    <!DOCTYPE html>
    <html>
    <head>
  ...
  `;
    try {
        ...
        const response = await fetch(`${ULTRAMSG_BASE_URL}/${ULTRAMSG_INSTANCE_ID}/messages/document`, {
            method: 'POST',
            headers: {
...
testWhatsAppPdf();
//# sourceMappingURL=test-whatsapp-pdf.js.map